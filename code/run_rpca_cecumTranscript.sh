...
mtb_file=$path/transcriptomics/data_files/cecum.nash.FT.stringtie.gene_count_matrix.tsv
md_file=$path/transcriptomics/cecum_md_with_nash_score_fibste.tsv
output_path=$path/transcriptomics/rpca_results_cecum/rpca_results_NASH_FT
...
#NASH FA
#path=/mnt/zarrinpar/scratch/sfloresr/NASH_KF
#mtb_file=$path/transcriptomics/data_files/cecum.nash.FA.stringtie.gene_count_matrix.tsv
#md_file=$path/transcriptomics/cecum_md_with_nash_score_fibste.tsv
#output_path=$path/transcriptomics/rpca_results_cecum/rpca_results_NASH_FA
#comparison=timepoint
#comparison2=NASH_category
#comparison3=fibrosis_stage_new
#comparison4=steatosis_grade_new
...
#NASH NA
#path=/mnt/zarrinpar/scratch/sfloresr/NASH_KF
#mtb_file=$path/transcriptomics/data_files/cecum.nash.NA.stringtie.gene_count_matrix.tsv
#md_file=$path/transcriptomics/cecum_md_with_nash_score.tsv
#output_path=$path/transcriptomics/rpca_results_cecum/rpca_results_NASH_NA
#comparison=timepoint

#NASH ZT13
#path=/mnt/zarrinpar/scratch/sfloresr/NASH_KF
#mtb_file=$path/transcriptomics/data_files/cecum.nash.ZT13.stringtie.gene_count_matrix.tsv
#md_file=$path/transcriptomics/cecum_md_with_nash_score_fibste.tsv
#output_path=$path/transcriptomics/rpca_results_cecum/rpca_results_NASH_ZT13
...
#NASH ZT1
#path=/mnt/zarrinpar/scratch/sfloresr/NASH_KF
#mtb_file=$path/transcriptomics/data_files/cecum.nash.ZT1.stringtie.gene_count_matrix.tsv
#md_file=$path/transcriptomics/cecum_md_with_nash_score_fibste.tsv
#output_path=$path/transcriptomics/rpca_results_cecum/rpca_results_NASH_ZT1
#comparison=condition
#comparison2=NASH_category
#comparison3=fibrosis_stage_new
#comparison4=steatosis_grade_new
...
#all NASH
#path=/mnt/zarrinpar/scratch/sfloresr/NASH_KF
#mtb_file=$path/transcriptomics/data_files/cecum.nash.stringtie.gene_count_matrix.tsv
#md_file=$path/transcriptomics/cecum_md_with_nash_score_fibste.tsv
#output_path=$path/transcriptomics/rpca_results_cecum/rpca_results_NASH_all
#comparison=condition
