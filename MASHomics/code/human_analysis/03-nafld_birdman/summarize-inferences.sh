...
#SBATCH --chdir=/home/sfloresr/projects/NALFD_ml/birdman_results/inferences/
#SBATCH --output=/home/sfloresr/projects/NALFD_ml/birdman_results/slurm_out/%x.out
...
for inference_dir in glob.glob('/home/sfloresr/projects/NALFD_ml/birdman_results/inferences/04.taxonomy_filtered.asv.counts.g1pg2p*'):

    FEAT_REGEX = re.compile("F\d{4}_(.*).nc")
    omic_ = inference_dir.split('/')[-1]
    outfile = "inferences-g1pg2p/%s.beta_var.tsv" % (omic_)
