...
#SBATCH --chdir=/mnt/zarrinpar/Pynchon/Notebooks/sfloresr/MASH-TRF/MASHomics/data/stool_16s/birdman_outputs/inferences/
#SBATCH --output=/mnt/zarrinpar/Pynchon/Notebooks/sfloresr/MASH-TRF/MASHomics/data/stool_16s/birdman_outputs/slurm_out/%x.out
...
for inference_dir in glob.glob('/mnt/zarrinpar/Pynchon/Notebooks/sfloresr/MASH-TRF/MASHomics/data/stool_16s/birdman_outputs/inferences/NASH*'):
